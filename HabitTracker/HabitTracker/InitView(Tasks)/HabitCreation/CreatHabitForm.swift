    ...
    var body: some View {
        ...
        VStack{
            ...
            .onTapGesture {
                ...
                let habitModel = HabitModel(name: name, id: "", createdDate: Date(), type: HabitTracker.HabitType(rawValue: habitType) ?? .simple, numberTarget: Int16(targetNumber), timeTarget: targetTime,  detail: detail, cycle: HabitCycle(rawValue: cycle) ?? .daily, unit: targetUnit, priority: 0, executionTime: "")
