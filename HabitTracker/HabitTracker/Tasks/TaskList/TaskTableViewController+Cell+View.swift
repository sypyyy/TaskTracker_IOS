...
class TaskTableViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UIScrollViewDelegate, ChangeListener {
    ...
    func setupSegmentedControl() {
        segmentedControlView = TaskViewSegmentedControl(options: ["clock", "flag", "folder", "scope"]) {idx in
...
struct TaskTableCellView: View {
    @StateObject var masterViewModel: MasterViewModel = MasterViewModel.shared
