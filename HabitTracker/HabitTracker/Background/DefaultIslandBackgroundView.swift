...
struct DefaultIslandBackgroundView: View {
    ...
    var body: some View {
        ...
        ZStack{
            ...
            sunShape(x: tabIndex == 2 ? 0.7 : 0.9, y: 0.4)
                .fill(Color(UIColor(Self.gradientEnd).lighter(by: tabIndex == 2 ? 20 : 25)))
                .blur(radius: tabIndex == 2 ? 50 : 20)
            /*
            ...
            sunShape(x: tabIndex == 2 ? 0.7 : 0.9, y: 0.4)
                ...
                .blur(radius: 50)
            sunShape(x: tabIndex == 2 ? 0.7 : 0.9, y: 0.4)
                .fill(Color(UIColor(tabIndex == 2  ? Self.gradientEnd : Self.gradientStart).lighter(by: tabIndex == 2 ? 40 : 25)))
